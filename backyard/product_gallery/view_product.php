...
<head>
    ...
    <!-- Title -->
    <title><?php echo $project_name; ?> | View Products</title>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-2">View Products</h4>
											...
											if($sql)
											{
												foreach($sql as $cat)
												{
													...
													<tr>
														...
														<td><img style="width:100px;height:70px;" src="../images/product_image/<?php echo $cat['product_image']; ?>"></td>
														<td><a href="View-Product-Gallery/<?php echo $cat['product_id'];?>"><img style="height: 30px;width: 30px;"  src="../img/eye.png"></a></td>
