...
<head>
    ...
    <!-- Title -->
    <title><?php echo $project_name; ?> | Add Coupon</title>
                       ...
                       <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="Insert-Coupon" name="f1" id="formsubmit" method="POST">
										...
										<div class="form-group">
                                            <label for="exampleInputName1">Coupon Discount (Ex: 10)</label>
		...
		$( document ).ready( function () {
			$( "#formsubmit" ).validate( {
				...
				messages: {
					...
					coupon_discount: "Please enter coupon discount",
