...
?>
<head>
	<base href="<?php echo $site_url; ?>backyard/coupon/">
    <meta charset="UTF-8">
    ...
    <!-- Title -->
    <title><?php echo $project_name; ?> | View Coupon</title>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-2">View Coupons</h4>
                                    ...
                                    <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                        ...
                                        <tbody>
										<?php
											$sql=$link->rawQuery("select * from coupon");
											if($sql)
											{
												foreach($sql as $cat)
												{
													?>
													<tr>
														<td><?php echo $cat['coupon_name']; ?></td>
														<td><?php echo $cat['coupon_discount']; ?></td>
													<?php
													if($cat['coupon_active']==1)
													{
														$flag=1;
														?>
															<td><a href="Inactive?pid=<?php echo $cat['coupon_id'];?>" class="btn btn-neutral" style="background-color:#00b200;color:#ffffff;"><?php echo "Active";?></a></td>
															
													<?php
													}
													elseif($cat['coupon_active']==0)
													{
														$flag=0;
														?>
														
															<td><a href="Active?pid=<?php echo $cat['coupon_id'];?>" class="btn btn-neutral" style="background-color:#FF0000;color:#ffffff;"><?php echo "Inactive";?></a></td>
														<?php
													}
													else{
														?>
													...
													?>	 
													<td><a href="Edit-Coupon/<?php echo $cat['coupon_id']; ?>"><img style="height: 30px;width: 30px;"  src="../img/edit.png"></a></td>
													<td><a onClick='javascript:confirmationDelete($(this));return false;' href="Delete-Coupon/<?php echo $cat['coupon_id'];?>"><img style="height: 30px;width: 30px;"  src="../img/delete.png"></a></td>
